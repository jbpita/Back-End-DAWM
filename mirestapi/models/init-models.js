...
function initModels(sequelize) {
  ...
  productos.belongsTo(marcas, { as: "id_marca_marca", foreignKey: "id_marca",onDelete: 'cascade', hooks: true});
  marcas.hasMany(productos, { as: "productos", foreignKey: "id_marca", onDelete: 'cascade', hooks: true});
  compras.belongsTo(metodospagos, { as: "id_metodo_metodospago", foreignKey: "id_metodo",onDelete: 'cascade', hooks: true});
  metodospagos.hasMany(compras, { as: "compras", foreignKey: "id_metodo",onDelete: 'cascade', hooks: true});
